...
# Load the image
input_img = Image.open('../reports/Image_Results/regularization/tubingen_schrei_iter_200_r0_s1000_c5.png')
input_arr = np.asarray(input_img, dtype='uint8')
output_res = denoise(input_arr, weight=29)
output_arr = np.asarray(output_res, dtype='uint8')

# Denoise and plot the result
